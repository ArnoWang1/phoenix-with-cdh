...
public class NamespaceSchemaMappingIT extends ParallelStatsDisabledIT {
    ...
    public void testBackWardCompatibility() throws Exception {
        ...
        HTableDescriptor fullHTD = new HTableDescriptor(TableName.valueOf(phoenixFullTableName));
        fullHTD.addFamily(new HColumnDescriptor(QueryConstants.DEFAULT_COLUMN_FAMILY_BYTES));
        admin.createTable(fullHTD);
